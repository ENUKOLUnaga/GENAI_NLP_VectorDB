...
#convert all reviews into embeddings
review_embedding=model.encode(reviews,show_progress_bar=True)
...
#get dimensions
dimension=review_embedding.shape[1]
#print(dimension)
#create faiss index - L2 distance
index=faiss.IndexFlatL2(dimension)

#add vectors to index
index.add(review_embedding)
...
def search_reviews(query,top_k=5):
    ...
    for i in indices[0]:
        print("-",reviews)
search_reviews("battery drains fast")
